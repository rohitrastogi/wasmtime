...
pub struct DebugInfoData<'a> {
    pub(crate) dwarf: Dwarf<'a>,
    pub(crate) code_section_offset: u64,
    pub(crate) function_offsets: Vec<(u64, u32)>,
}
    ...
    while !reader.eof() {
        ...
        if let SectionCode::Code = section.code {
            ...
            for _ in 0..reader.get_count() {
                ...
                function_offsets.push((fn_body_offset as u64, fn_body_size as u32));
            }
        }
    }
    DebugInfoData {
